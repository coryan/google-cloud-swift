...
// We need `public import` because public functions in this module consume and return types from
// GoogleCloudGax (e.g. `ClientOptions`, `_HeaderNames`, and `SwiftProtobuf.Message`):
...
@_spi(GoogleCloudInternal) public import GoogleCloudGax
...
public final class _GRPCClient: Sendable {
  ...
  public init(
    from options: GoogleCloudGax.ClientOptions,
